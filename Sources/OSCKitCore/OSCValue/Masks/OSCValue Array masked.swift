...
extension Array where Element == any OSCValue {
    ...
    ///
    /// Meta types:
    /// - `OSCNumberValue.self` (matches `.int32`, `.float32`, `.double`, `.int64`)
    ///
...
extension Array where Element == any OSCValue {
    ...
    /// - Throws: `OSCValueMask.MaskError`
    @inlinable
    public func masked<V0, V1, V2, V3, V4>(
        _ v0: V0.Type,
        _ v1: V1.Type,
        _ v2: V2.Type,
        _ v3: V3.Type,
...
extension Array where Element == any OSCValue {
    ...
    /// - Throws: `OSCValueMask.MaskError`
    @inlinable
    public func masked<V0, V1, V2, V3, V4, V5>(
        _ v0: V0.Type,
        _ v1: V1.Type,
        _ v2: V2.Type,
        _ v3: V3.Type,
...
extension Array where Element == any OSCValue {
    ...
    /// - Throws: `OSCValueMask.MaskError`
    @inlinable
    public func masked<V0, V1, V2, V3, V4, V5, V6, V7>(
        _ v0: V0.Type,
        _ v1: V1.Type,
        _ v2: V2.Type,
        _ v3: V3.Type,

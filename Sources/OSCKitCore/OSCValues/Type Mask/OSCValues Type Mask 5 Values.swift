...
extension OSCValues {
    ...
    public func masked<V0: OSCValueMaskable, V1: OSCValueMaskable, V2: OSCValueMaskable, V3: OSCValueMaskable, V4: OSCValueMaskable>(
        _ v0: V0.Type,
        _ v1: V1.Type,
        _ v2: V2.Type,
        _ v3: V3.Type,
        _ v4: V4.Type
    ) throws(OSCValueMaskError) -> (V0, V1, V2, V3, V4) {
        try validateCount(5)

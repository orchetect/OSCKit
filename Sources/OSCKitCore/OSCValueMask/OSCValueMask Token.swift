...
extension OSCValueMask {
    ...
    public enum Token: Int, CaseIterable, Equatable, Hashable {
        // concrete types
...
//            
//        // meta types
//        case .number,       .numberOptional:    return OSCNumberValue.self
//        }
//    }
//}

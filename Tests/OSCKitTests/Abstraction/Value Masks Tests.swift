...
//  OSCKitTests
//
//  Created by Steffan Andrews on 2019-10-28.
...
class ValueMasksTests: XCTestCase {
	...
	func testBaseTypeMatches_int32() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .int32: XCTAssertTrue (val.baseTypeMatches(type: valueType))
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .int32, .number: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_float32() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .float32: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .float32, .number: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_string() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .string: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_blob() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .blob: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .blob: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_int64() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .int64: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .int64, .number: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_timeTag() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .timeTag: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .timeTag: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_double() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .double: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .double, .number: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_stringAlt() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .stringAlt: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .stringAlt: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_character() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .character: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .character: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_midi() {
		...
		let val = OSCMessageValue.midi(OSCMIDIMessage(portID: 0x00, status: 0x00, data1: 0x00, data2: 0x00))

		// canMatchMetaTypes: false
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .midi: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .midi: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_bool() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .bool: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .bool: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testBaseTypeMatches_null() {
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .null: XCTAssertTrue (val.baseTypeMatches(type: valueType))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType))
			}
		}
		...
		OSCMessageValueType.allCases.forEach { valueType in
			switch valueType {
			case .null: XCTAssertTrue (val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			default: XCTAssertFalse(val.baseTypeMatches(type: valueType, canMatchMetaTypes: true))
			}
		}
	...
	func testValuesFromValueMask_int32() {
		...
		let result = [OSCMessageValue]([msgValue]).valuesFromValueMask(expectedMask: [valueType])
	...
	func testValuesFromValueMask_midi() {
		...
		typealias type                     = OSCMIDIMessage
		let value                          = OSCMIDIMessage(portID: 0x00, status: 0x80, data1: 0x50, data2: 0x40) as type

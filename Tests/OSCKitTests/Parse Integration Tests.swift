...
final class ParseIntegrationTests: XCTestCase {
	...
	func testParseData_Message_Error() {
	...
	func testParseData_Bundle_Error() {
	...
	func testParseData_Bundle_ErrorInContainedMessage() {
